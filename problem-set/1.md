...
By determinant definition, $det (A \cdot B) \epsilon(\mathbf{e}_1, ..., \mathbf{e}_n) = \epsilon((A\cdot B)(\mathbf{e}_1,), ..., (A\cdot B)(\mathbf{e}_n, )) = \epsilon((A(B(\mathbf{e}_1,),), ..., A(B(\mathbf{e}_n,),)) = det A \epsilon(B(\mathbf{e}_1,), ..., B(\mathbf{e}_n, )) = det A det B \epsilon(\mathbf{e}_1, ..., \mathbf{e}_n)$.
